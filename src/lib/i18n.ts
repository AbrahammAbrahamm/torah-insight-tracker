...
export const HEBREW_NAMES: Record<string, string> = {
  ...
  'Shabbat': 'שבת', 'Eruvin': 'עירובין', 'Shevitat Asor': 'שביתת עשור',
  'Shevitat Yom Tov': 'שביתת יום טוב', 'Chametz uMatzah': 'חמץ ומצה',
  'Shofar veSukkah veLulav': 'שופר וסוכה ולולב', 'Shekalim': 'שקלים',
  ...
  "Na'arah Betulah": 'נערה בתולה', 'Sotah': 'סוטה',
  ...
  'Kilayim': 'כלאים', 'Matnot Aniyim': 'מתנות עניים', 'Terumot': 'תרומות',
  "Ma'aser": 'מעשר', "Ma'aser Sheni": 'מעשר שני', 'Bikkurim': 'ביכורים',
  ...
  "Me'ilah": 'מעילה',
  'Korban Pesach': 'קרבן פסח', 'Chagigah': 'חגיגה', 'Bechorot': 'בכורות',
  'Shegagot': 'שגגות', 'Mechusrei Kapparah': 'מחוסרי כפרה', 'Temurah': 'תמורה',
  ...
  'Sanhedrin': 'סנהדרין', 'Edut': 'עדות', 'Mamrim': 'ממרים',
